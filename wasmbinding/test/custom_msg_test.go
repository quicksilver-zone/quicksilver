...
func prepareSwapState(t *testing.T, ctx sdk.Context, osmosis *app.Quicksilver) BaseState {
...
func executeCustom(t *testing.T, ctx sdk.Context, osmosis *app.Quicksilver, contract sdk.AccAddress, sender sdk.AccAddress, msg bindings.OsmosisMsg, funds sdk.Coin) error {

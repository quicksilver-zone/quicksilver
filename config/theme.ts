...
import { mode } from "@chakra-ui/theme-tools";
 ...
 const defaultThemeObject = {
  styles: {
    global: (props: { colorMode: string; }) => ({
      body: {
        ...
        color: props.colorMode === 'dark' ? "rgb(255, 255, 255)" : "rgb(0, 0, 0)",
      }
    })
  },
  colors: {
    ...
    primaryGlow: {
      light: "conic-gradient(from 180deg at 50% 50%, #16abff33 0deg, #0885ff33 55deg, #54d6ff33 120deg, #0071ff33 160deg, transparent 360deg)",
  ...
  components: {
    ...
    Box: {
      baseStyle: {
        boxShadow: "0 4px 6px rgba(255, 190, 190, 0.1), 0 1px 3px rgba(255, 190, 190, 0.1)",
        width: "md",
        height: "md",
      },
    },

...
require (
	...
	github.com/quicksilver-zone/quicksilver v1.4.0-rc1
...
replace (
	...
	github.com/strangelove-ventures/lens => github.com/notional-labs/lens ef6357ae82c7385cda35c1989a1bed6d3f6b34b8
)

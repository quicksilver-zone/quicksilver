<!-- omit in toc -->
# Contributing to Quicksilver Protocol
...
- Star the project
- Tweet about it
- Tell your friends/colleagues about Quicksilver!
...
> If you want to ask a question, we assume that you have read the available [Documentation](https://docs.quicksilver.zone).

Before you ask a question, it is best to search for existing [Issues](https://github.com/quicksilver-zone/quicksilver/issues) that might help you. In case you have found a suitable issue and still need clarification, you can write your question in this issue. It is also advisable to search the internet for answers first.
...
> You must never report security related issues, vulnerabilities or bugs including sensitive information to the issue tracker, or elsewhere in public. Instead sensitive bugs must be sent by email to <security@quicksilver.zone>. See [SECURITY.md](SECURITY.md) for further details.
...
- **Explain why this enhancement would be useful** to most Quicksilver Protocol users. You may also want to point out the other projects that solved it better and which could serve as inspiration.

...
type SingleQuery struct {
	...
	QueryType       string                                 `protobuf:"bytes,4,opt,name=query_type,json=queryType,proto3" json:"query_type,omitempty"`
	QueryParameters map[string]string                      `protobuf:"bytes,5,rep,name=query_parameters,json=queryParameters,proto3" json:"query_parameters,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	EmitHeight      github_com_cosmos_cosmos_sdk_types.Int `protobuf:"bytes,6,opt,name=emit_height,json=emitHeight,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"emit_height"`
}
...
var fileDescriptor_90232048b76e95cc = []byte{
	...
	,
}
...
func (m *SingleQuery) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.EmitHeight.Size()
		i -= size
		if _, err := m.EmitHeight.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintGenesis(dAtA, i, uint64(size))
	}
...
func (m *SingleQuery) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EmitHeight", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EmitHeight.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

...
type GetTxWithProofResponse struct {
	...
	ProofAny *types2.Any `protobuf:"bytes,5,opt,name=proof_any,json=proofAny,proto3" json:"proof_any,omitempty"`
}
...
func (m *GetTxWithProofResponse) GetProofAny() *types2.Any {
	if m != nil {
		return m.ProofAny
	}
	return nil

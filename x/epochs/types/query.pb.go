...
func (*QueryEpochsInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d28835f99bce7ae, []int{0}
}
...
func (*QueryEpochsInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d28835f99bce7ae, []int{1}
}
...
func (*QueryCurrentEpochRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d28835f99bce7ae, []int{2}
}
...
func (*QueryCurrentEpochResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6d28835f99bce7ae, []int{3}
}
...
func init() {
	proto.RegisterType((*QueryEpochsInfoRequest)(nil), "quicksilver.epochs.v1.QueryEpochsInfoRequest")
	proto.RegisterType((*QueryEpochsInfoResponse)(nil), "quicksilver.epochs.v1.QueryEpochsInfoResponse")
	proto.RegisterType((*QueryCurrentEpochRequest)(nil), "quicksilver.epochs.v1.QueryCurrentEpochRequest")
	proto.RegisterType((*QueryCurrentEpochResponse)(nil), "quicksilver.epochs.v1.QueryCurrentEpochResponse")
}

func init() { proto.RegisterFile("quicksilver/epochs/v1/query.proto", fileDescriptor_6d28835f99bce7ae) }

var fileDescriptor_6d28835f99bce7ae = []byte{
	// 480 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) EpochInfos(ctx context.Context, in *QueryEpochsInfoRequest, opts ...grpc.CallOption) (*QueryEpochsInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/quicksilver.epochs.v1.Query/EpochInfos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CurrentEpoch(ctx context.Context, in *QueryCurrentEpochRequest, opts ...grpc.CallOption) (*QueryCurrentEpochResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/quicksilver.epochs.v1.Query/CurrentEpoch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "quicksilver.epochs.v1.Query",
	...
	Metadata: "quicksilver/epochs/v1/query.proto",
}

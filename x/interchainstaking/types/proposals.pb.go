...
type MsgRegisterZone struct {
	...
	LocalDenom       string       `protobuf:"bytes,5,opt,name=local_denom,json=localDenom,proto3" json:"local_denom,omitempty" yaml:"local_denom"`
	AccountPrefix    string       `protobuf:"bytes,6,opt,name=account_prefix,json=accountPrefix,proto3" json:"account_prefix,omitempty" yaml:"account_prefix"`
	LiquidityModule  bool         `protobuf:"varint,7,opt,name=liquidity_module,json=liquidityModule,proto3" json:"liquidity_module,omitempty"`
	MessagesPerTx    int64        `protobuf:"varint,8,opt,name=messages_per_tx,json=messagesPerTx,proto3" json:"messages_per_tx,omitempty"`
	...
	Is_118           bool         `protobuf:"varint,13,opt,name=is_118,json=is118,proto3" json:"is_118,omitempty"`
	SubzoneInfo      *SubzoneInfo `protobuf:"bytes,14,opt,name=subzoneInfo,proto3" json:"subzoneInfo,omitempty"`
	Authority        string       `protobuf:"bytes,15,opt,name=authority,proto3" json:"authority,omitempty"`
}
...
var fileDescriptor_04d034c830a7acfe = []byte{
	...
	,
}

...
type Params struct {
	...
	AuthzAutoClaimAddress string                                 `protobuf:"bytes,5,opt,name=authz_auto_claim_address,json=authzAutoClaimAddress,proto3" json:"authz_auto_claim_address,omitempty"`
}
...
func (m *Params) GetAuthzAutoClaimAddress() string {
	if m != nil {
		return m.AuthzAutoClaimAddress
	}
	return ""
}
...
var fileDescriptor_196cdf77e041fc72 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.AuthzAutoClaimAddress != that1.AuthzAutoClaimAddress {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.AuthzAutoClaimAddress) > 0 {
		i -= len(m.AuthzAutoClaimAddress)
		copy(dAtA[i:], m.AuthzAutoClaimAddress)
		i = encodeVarintGenesis(dAtA, i, uint64(len(m.AuthzAutoClaimAddress)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AuthzAutoClaimAddress", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AuthzAutoClaimAddress = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenesis(dAtA[iNdEx:])

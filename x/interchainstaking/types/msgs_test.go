...
func TestGovSetLsmCaps(t *testing.T) {
	cases := []struct {
		...
		{
			Name: "valid",
			Msg:  types.MsgGovSetLsmCaps{Title: "test", Description: "test", ChainId: "chain-1", Caps: &types.LsmCaps{ValidatorCap: sdk.OneDec(), ValidatorBondCap: sdkmath.LegacyNewDec(250), GlobalCap: sdkmath.LegacyNewDecWithPrec(50, 2)}, Authority: addressutils.GenerateAddressForTestWithPrefix("quick")},
			Err:  "",
		},
		{
			Name: "invalid empty chain id",
			Msg:  types.MsgGovSetLsmCaps{Title: "test", Description: "test", Caps: &types.LsmCaps{ValidatorCap: sdk.OneDec(), ValidatorBondCap: sdkmath.LegacyNewDec(250), GlobalCap: sdkmath.LegacyNewDecWithPrec(50, 2)}, Authority: addressutils.GenerateAddressForTestWithPrefix("quick")},
			Err:  "invalid chain id",
		},
		{
			Name: "invalid bad authority",
			Msg:  types.MsgGovSetLsmCaps{Title: "test", Description: "test", Caps: &types.LsmCaps{ValidatorCap: sdk.OneDec(), ValidatorBondCap: sdkmath.LegacyNewDec(250), GlobalCap: sdkmath.LegacyNewDecWithPrec(50, 2)}, Authority: "raa"},
			Err:  "decoding bech32 failed: invalid bech32 string length 3",
		},
		{
			Name: "invalid validator cap < 0",
			Msg:  types.MsgGovSetLsmCaps{Title: "test", Description: "test", ChainId: "chain-1", Caps: &types.LsmCaps{ValidatorCap: sdk.OneDec().Neg(), ValidatorBondCap: sdkmath.LegacyNewDec(250), GlobalCap: sdkmath.LegacyNewDecWithPrec(50, 2)}, Authority: addressutils.GenerateAddressForTestWithPrefix("quick")},
		...
		},
		{
			...
			Msg:  types.MsgGovSetLsmCaps{Title: "test", Description: "test", ChainId: "chain-1", Caps: &types.LsmCaps{ValidatorCap: sdk.OneDec(), ValidatorBondCap: sdkmath.LegacyNewDec(250).Neg(), GlobalCap: sdkmath.LegacyNewDecWithPrec(50, 2)}, Authority: addressutils.GenerateAddressForTestWithPrefix("quick")},
		...
		},
		{
			...
			Msg:  types.MsgGovSetLsmCaps{Title: "test", Description: "test", ChainId: "chain-1", Caps: &types.LsmCaps{ValidatorCap: sdk.OneDec(), ValidatorBondCap: sdkmath.LegacyNewDec(250), GlobalCap: sdkmath.LegacyNewDecWithPrec(50, 1)}, Authority: addressutils.GenerateAddressForTestWithPrefix("quick")},
			Err:  "global cap must be between 0 and 1",
		},
		{
			Name: "invalid - global cap < 0",
			Msg:  types.MsgGovSetLsmCaps{Title: "test", Description: "test", ChainId: "chain-1", Caps: &types.LsmCaps{ValidatorCap: sdk.OneDec(), ValidatorBondCap: sdkmath.LegacyNewDec(250), GlobalCap: sdkmath.LegacyNewDecWithPrec(50, 2).Neg()}, Authority: addressutils.GenerateAddressForTestWithPrefix("quick")},
			Err:  "global cap must be between 0 and 1",
		},
	}

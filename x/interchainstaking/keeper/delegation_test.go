...
func (suite *KeeperTestSuite) TestKeeper_DelegationStore() {
	...
	updateDelegation, found := icsKeeper.GetPerformanceDelegation(ctx, &zone, zoneValidatorAddresses[0].ValoperAddress)
	suite.Require().True(found)
	...
	updatedDelegation, found := icsKeeper.GetPerformanceDelegation(ctx, &zone, zoneValidatorAddresses[0].ValoperAddress)
	suite.Require().True(found)
	...
	icsKeeper.SetDelegation(
		...
		icstypes.NewDelegation(
			...
			zoneValidatorAddresses[0].ValoperAddress,
	...
	icsKeeper.SetDelegation(
		...
		icstypes.NewDelegation(
			zone.DelegationAddress.Address,
			zoneValidatorAddresses[1].ValoperAddress,
	...
	icsKeeper.SetDelegation(
		...
		icstypes.NewDelegation(
			zone.DelegationAddress.Address,
			zoneValidatorAddresses[2].ValoperAddress,

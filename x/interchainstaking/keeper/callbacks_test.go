...
// TODO: encode all the hand write stuff to base64, even better if we can get find a way to get tx with out hand write all of this.
func (suite *KeeperTestSuite) TestDepositTxCallback() {
	suite.Run("Deposit transaction successful", func() {
		...
		txWithProofBz := decodeBase64NoErr(anotherDepositTxFixture)
		txRes := icqtypes.GetTxWithProofResponse{}
		quicksilver.InterchainQueryKeeper.IBCKeeper.Codec().MustUnmarshal(txWithProofBz, &txRes)

		// // construct Header for tx
		// connection, _ := quicksilver.InterchainstakingKeeper.IBCKeeper.ConnectionKeeper.GetConnection(ctx, suite.path.EndpointA.ConnectionID)
		// consensusState, _ := quicksilver.InterchainstakingKeeper.IBCKeeper.ClientKeeper.GetClientConsensusState(ctx, connection.ClientId, res.Header.TrustedHeight)

		// // Construct a trusted header using the fields in consensus state
		// // Only Height, Time, and NextValidatorsHash are necessary for verification
		// trustedHeader := tmtypes.Header{
		// 	ChainID:            suite.chainB.ChainID,
		// 	Height:             int64(10076458),
		// 	Time:               consState.Timestamp,
		// 	NextValidatorsHash: consState.NextValidatorsHash,
		// }
		// fmt.Println("tH: ", trustedHeader)
		...
		// 	key := fmt.Sprintf("%d", i)
		// 	headerBz = append(headerBz, byte(headerMap[key]))
		// }
		// header := qstypes.MsgSubmitQueryResponse{}
		// quicksilver.InterchainQueryKeeper.IBCKeeper.Codec().MustUnmarshal(headerBz, &header)
...
var anotherDepositTxFixture = ``

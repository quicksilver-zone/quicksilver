...
func (suite *KeeperTestSuite) TestKeeper_IntentStore() {
	...
	zoneValidatorAddresses := icsKeeper.GetValidators(ctx, zone.BaseChainID())
	...
	tc := []struct {
	...
	}{
		{
			...
			expected: func(ctx sdk.Context, qs *app.Quicksilver, zone icstypes.Zone) icstypes.ValidatorIntents {
				...
				for _, val := range qs.InterchainstakingKeeper.GetValidatorAddresses(ctx, zone.BaseChainID()) {
		...
		},
		{
			...
			intents: func(ctx sdk.Context, qs *app.Quicksilver, zone icstypes.Zone) []icstypes.DelegatorIntent {
				out := make([]icstypes.DelegatorIntent, 0)
				out = append(out, icstypes.DelegatorIntent{Delegator: user1.String(), Intents: icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: qs.InterchainstakingKeeper.GetValidatorAddresses(ctx, zone.BaseChainID())[0], Weight: sdk.OneDec()}}})
				return out
			},
			balances: func() map[string]int64 { return map[string]int64{} },
			expected: func(ctx sdk.Context, qs *app.Quicksilver, zone icstypes.Zone) icstypes.ValidatorIntents {
		...
		},
		{
			...
			intents: func(ctx sdk.Context, qs *app.Quicksilver, zone icstypes.Zone) []icstypes.DelegatorIntent {
				out := make([]icstypes.DelegatorIntent, 0)
				out = append(out,
					icstypes.DelegatorIntent{Delegator: user1.String(), Intents: icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: qs.InterchainstakingKeeper.GetValidatorAddresses(ctx, zone.BaseChainID())[0], Weight: sdk.OneDec()}}},
					icstypes.DelegatorIntent{Delegator: user2.String(), Intents: icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: qs.InterchainstakingKeeper.GetValidatorAddresses(ctx, zone.BaseChainID())[0], Weight: sdk.OneDec()}}},
				)
				return out
			},
			balances: func() map[string]int64 {
		...
		},
		{
			...
			intents: func(ctx sdk.Context, qs *app.Quicksilver, zone icstypes.Zone) []icstypes.DelegatorIntent {
				...
				out = append(out,
					icstypes.DelegatorIntent{Delegator: user1.String(), Intents: icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: qs.InterchainstakingKeeper.GetValidatorAddresses(ctx, zone.BaseChainID())[0], Weight: sdk.OneDec()}}},
					icstypes.DelegatorIntent{Delegator: user2.String(), Intents: icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: qs.InterchainstakingKeeper.GetValidatorAddresses(ctx, zone.BaseChainID())[1], Weight: sdk.OneDec()}}},
				)
				return out
			},
			balances: func() map[string]int64 {
		...
		},
		{
			...
			intents: func(ctx sdk.Context, qs *app.Quicksilver, zone icstypes.Zone) []icstypes.DelegatorIntent {
				out := make([]icstypes.DelegatorIntent, 0)
				out = append(out,
					icstypes.DelegatorIntent{Delegator: user1.String(), Intents: icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: qs.InterchainstakingKeeper.GetValidatorAddresses(ctx, zone.BaseChainID())[0], Weight: sdk.ZeroDec()}}},
					icstypes.DelegatorIntent{Delegator: user2.String(), Intents: icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: qs.InterchainstakingKeeper.GetValidatorAddresses(ctx, zone.BaseChainID())[1], Weight: sdk.OneDec()}}},
				)
				return out
			},

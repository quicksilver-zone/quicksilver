	...
	tests := []struct {
		...
		},
		{
			...
			delegatorRewards: func(ctx sdk.Context, appA *app.Quicksilver, chainID string) distributiontypes.QueryDelegationTotalRewardsResponse {
				...
				return distributiontypes.QueryDelegationTotalRewardsResponse{Rewards: []distributiontypes.DelegationDelegatorReward{{ValidatorAddress: valAddress, Reward: sdk.NewDecCoins(sdk.NewDecCoin(zone.BaseDenom, sdkmath.NewInt(1)))}}, Total: sdk.DecNewCoins(sdkmath.LegacyNewDecCoin(zone.BaseDenom, sdkmath.NewInt(0)))}
			},
			verify: func(_ types.ZoneScore, _ []distributiontypes.DelegationDelegatorReward, _ []icstypes.Validator) {
			},
			wantErr: false,
		},
		{
			...
			delegatorRewards: func(ctx sdk.Context, appA *app.Quicksilver, chainID string) distributiontypes.QueryDelegationTotalRewardsResponse {
				...
				return distributiontypes.QueryDelegationTotalRewardsResponse{Rewards: []distributiontypes.DelegationDelegatorReward{
					{ValidatorAddress: inactiveAddress, Reward: sdk.DecNewCoins(sdkmath.LegacyNewDecCoin(zone.BaseDenom, sdkmath.NewInt(1)))},
					{ValidatorAddress: activeAddress, Reward: sdk.DecNewCoins(sdkmath.LegacyNewDecCoin(zone.BaseDenom, sdkmath.NewInt(10)))},
				}, Total: sdk.DecNewCoins(sdkmath.LegacyNewDecCoin(zone.BaseDenom, sdkmath.NewInt(11)))}
			},
		...
		},
		{
			...
			delegatorRewards: func(ctx sdk.Context, appA *app.Quicksilver, chainID string) distributiontypes.QueryDelegationTotalRewardsResponse {
				...
				return distributiontypes.QueryDelegationTotalRewardsResponse{Rewards: []distributiontypes.DelegationDelegatorReward{
					{ValidatorAddress: validators[0], Reward: sdk.DecNewCoins(sdkmath.LegacyNewDecCoin(zone.BaseDenom, sdkmath.NewInt(5)))},
					{ValidatorAddress: validators[1], Reward: sdk.DecNewCoins(sdkmath.LegacyNewDecCoin(zone.BaseDenom, sdkmath.NewInt(10)))},
					{ValidatorAddress: validators[2], Reward: sdk.DecNewCoins(sdkmath.LegacyNewDecCoin(zone.BaseDenom, sdkmath.NewInt(15)))},
				}, Total: sdk.DecNewCoins(sdkmath.LegacyNewDecCoin(zone.BaseDenom, sdkmath.NewInt(30)))}
			},
			verify: func(zs types.ZoneScore, delegatorRewards []distributiontypes.DelegationDelegatorReward, validators []icstypes.Validator) {

...
func (suite *KeeperTestSuite) TestCalcUserValidatorSelectionAllocations() {
	tests := []struct {
		...
		validatorScores func(sdk.Context, *app.Quicksilver, *icstypes.Zone) map[string]*types.Validator
	...
	}{
		{
			...
			validatorScores: func(context sdk.Context, quicksilver *app.Quicksilver, zone *icstypes.Zone) map[string]*types.Validator {
				return nil
			},
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, appA *app.Quicksilver) {
				...
				validatorIntents := icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[0], Weight: sdk.NewDec(0)}}
			...
			validatorScores: func(ctx sdk.Context, appA *app.Quicksilver, zone *icstypes.Zone) map[string]*types.Validator {
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, appA *app.Quicksilver) {
				...
				validatorIntents := icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[0], Weight: sdk.NewDec(1)}}
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, appA *app.Quicksilver) {
				...
				validatorIntentsA := icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[0], Weight: sdk.NewDec(1)}}
				validatorIntentsB := icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[1], Weight: sdk.NewDec(1)}}
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, appA *app.Quicksilver) {
				...
				validatorIntentsA := icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[0], Weight: sdk.NewDec(10)}}
				validatorIntentsB := icstypes.ValidatorIntents{&icstypes.ValidatorIntent{ValoperAddress: appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[0], Weight: sdk.NewDec(100)}}
	...
	tests := []struct {
	...
	}{
		{
			...
			malleate: func(ctx sdk.Context, appA *app.Quicksilver) {
				...
				for _, val := range appA.InterchainstakingKeeper.GetValidators(ctx, &zone) {
					address, _ := val.GetAddressBytes()
					appA.InterchainstakingKeeper.DeleteValidator(ctx, &zone, address)
				}
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, appA *app.Quicksilver) {
				...
				for i := range validators {
					...
					appA.InterchainstakingKeeper.SetValidator(ctx, &zone, validators[i])
				}
		...
		},
		{
			...
			malleate: func(ctx sdk.Context, appA *app.Quicksilver) {
				...
				for i, val := range appA.InterchainstakingKeeper.GetValidators(ctx, &zone) {
					val.VotingPower = sdk.NewInt(int64(10 + i*10))
					appA.InterchainstakingKeeper.SetValidator(ctx, &zone, val)
				}
				zone.ValidatorSelectionAllocation = 5000
			...
			validatorScores: func(ctx sdk.Context, appA *app.Quicksilver, zone *icstypes.Zone) map[string]*types.Validator {
				...
				vals := appA.InterchainstakingKeeper.GetValidators(ctx, zone)
	...
	tests := []struct {
		...
		},
		{
			...
			delegatorRewards: func(ctx sdk.Context, appA *app.Quicksilver, chainID string) distributiontypes.QueryDelegationTotalRewardsResponse {
				zone, _ := appA.InterchainstakingKeeper.GetZone(ctx, suite.chainB.ChainID)
				valAddress := appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[0]
		...
		},
		{
			...
			validatorScores: func(ctx sdk.Context, appA *app.Quicksilver, zone *icstypes.Zone) map[string]*types.Validator {
				...
				val := appA.InterchainstakingKeeper.GetValidators(ctx, zone)[1]
			...
			delegatorRewards: func(ctx sdk.Context, appA *app.Quicksilver, chainID string) distributiontypes.QueryDelegationTotalRewardsResponse {
				zone, _ := appA.InterchainstakingKeeper.GetZone(ctx, suite.chainB.ChainID)
				inactiveAddress := appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[0]
				activeAddress := appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)[1]
		...
		},
		{
			...
			delegatorRewards: func(ctx sdk.Context, appA *app.Quicksilver, chainID string) distributiontypes.QueryDelegationTotalRewardsResponse {
				zone, _ := appA.InterchainstakingKeeper.GetZone(ctx, suite.chainB.ChainID)
				validators := appA.InterchainstakingKeeper.GetValidatorAddresses(ctx, &zone)
				return distributiontypes.QueryDelegationTotalRewardsResponse{Rewards: []distributiontypes.DelegationDelegatorReward{

...
func (CrescentModule) Hooks(ctx sdk.Context, k *Keeper) {
	...
	// update pool data
	k.IteratePrefixedProtocolDatas(ctx, rewardstypes.GetPrefixProtocolDataKey(rewardstypes.ProtocolDataTypeCrescentPool), func(idx int64, _ []byte, data rewardstypes.ProtocolData) bool {
	...
	k.IteratePrefixedProtocolDatas(ctx, rewardstypes.GetPrefixProtocolDataKey(rewardstypes.ProtocolDataTypeCrescentPoolCoinSupply), func(idx int64, _ []byte, data rewardstypes.ProtocolData) bool {

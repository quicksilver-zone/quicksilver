...
func (suite *KeeperTestSuite) TestOsmosisPoolUpdateCallback() {
	...
	data, err := types.UnmarshalProtocolData(types.ProtocolDataType(types.ProtocolDataTypeOsmosisPool), pd.GetData())
	suite.NoError(err)
...
func (suite *KeeperTestSuite) TestOsmosisClPoolUpdateCallback() {
	...
	data, err := types.UnmarshalProtocolData(types.ProtocolDataType(types.ProtocolDataTypeOsmosisCLPool), pd.GetData())
	suite.NoError(err)

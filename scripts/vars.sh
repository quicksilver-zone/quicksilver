...
QS1_RUN="docker-compose --ansi never run -T quicksilver quicksilverd"
QS2_RUN="docker-compose --ansi never run -T quicksilver2 quicksilverd"
QS3_RUN="docker-compose --ansi never run -T quicksilver3 quicksilverd"
TZ1_1_RUN="docker-compose --ansi never run -T testzone1-1 icad"
TZ1_2_RUN="docker-compose --ansi never run -T testzone1-2 icad"
TZ1_3_RUN="docker-compose --ansi never run -T testzone1-3 icad"
TZ1_4_RUN="docker-compose --ansi never run -T testzone1-4 icad"
TZ2_1_RUN="docker-compose --ansi never run -T testzone2-1 osmosisd"
...
RLY_RUN="docker-compose --ansi never run -T relayer"

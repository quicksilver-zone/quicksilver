...
sleep 5
##staking validator-bond cosmosvaloper13h5xdxhsdaugwdrkusf8lkgu406h8t62jkqv3h
## TODO: get val2 valoper from keys
## Creating a delegation
$TZ1_1_EXEC tx staking delegate $VAL_VALOPER_2 780000000uatom --from val2 --gas 400000 --chain-id $CHAINID_1 -y --keyring-backend=test
sleep 5
## Marking delegation as Validator Bond
#$TZ1_1_EXEC tx staking validator-bond $VAL_VALOPER_2 --from val2 --gas 400000 --chain-id $CHAINID_1 -y --keyring-backend=test
sleep 5
...
## Creating a delegation
$TZ1_1_EXEC tx staking delegate $VAL_VALOPER_3 780000000uatom --from val3 --gas 400000 --chain-id $CHAINID_1 -y --keyring-backend=test
sleep 5
...
## Creating a delegation
$TZ1_1_EXEC tx staking delegate $VAL_VALOPER_4 780000000uatom --from val4 --gas 400000 --chain-id $CHAINID_1 -y --keyring-backend=test
sleep 5
...
sleep 5
#echo "Tokenizing Shares"
$TZ1_1_EXEC tx staking delegate $VAL_VALOPER_2 36000000uatom --from demowallet2 --gas 400000 --chain-id $CHAINID_1 -y --keyring-backend=test
sleep 5
$TZ1_1_EXEC tx staking tokenize-share $VAL_VALOPER_2 3600000uatom $VAL_ADDRESS_2 --from demowallet2 --gas 400000 --chain-id $CHAINID_1 -y --keyring-backend=test   #4
$TZ1_2_EXEC tx bank send val3 $DEPOSIT_ACCOUNT 10000000${VAL_VALOPER_3}2 --chain-id $CHAINID_1 -y --keyring-backend=test
#echo "Tokenizing Shares Done"
sleep 5

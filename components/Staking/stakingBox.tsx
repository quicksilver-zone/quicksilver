...
import {
  Box, Tabs, TabList, Tab, TabPanels, TabPanel, VStack, Text,
  Flex, Stat, StatLabel, StatNumber, Input, Divider, HStack,
  Button, Spacer
} from "@chakra-ui/react";
import { MultiModal } from "./modals/multiStakeModal";

const StakingBox = ({ selectedOption, isModalOpen, setModalOpen }) => (
<Box 
              position="relative"

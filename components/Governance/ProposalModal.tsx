...
export const ProposalModal = ({
  ...
  const turnout =
    totalVotes / Number(bondedTokens);

  const minStakedTokens =
    quorum &&
    exponentiate(
      quorum * Number(bondedTokens),
      -exponent,
    ).toFixed(6);
  ...
  const description =
    getDescritpionFromProposal(proposal);
                  ...
                  <Box pr={2}>
                    ...
                    {quorum && (
                      <Text
                        ...
                        fontWeight="semibold"
                      >
                        {`Minimum of staked ${minStakedTokens} ${
                          coin.symbol
                        }(${
                          quorum * 100
                        }%) need to vote

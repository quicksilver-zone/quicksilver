...
// Strategy: mint-to-cover — if the escrow balance is short of the total qAsset
...
// account before refunding users. This guarantees every WDR is refunded in full.
//
...
func V0101003UpgradeHandler(
	...
	return func(ctx sdk.Context, _ upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
		ctx.Logger().Info("Starting v1.10.3 upgrade (mint-to-cover sunset)")

...
// --- v1.10.3 sunset tests (mint-to-cover strategy) ---
...
func (s *AppTestSuite) TestV0101003UpgradeHandler_MintToCover_Shortfall() {
	s.SetupTest()
	app := s.GetQuicksilverApp(s.chainA)
	ctx := s.chainA.GetContext()
...
func (s *AppTestSuite) TestV0101003UpgradeHandler_MintToCover_Exact() {
	s.SetupTest()
	app := s.GetQuicksilverApp(s.chainA)
	ctx := s.chainA.GetContext()
...
func (s *AppTestSuite) TestV0101003UpgradeHandler_MintToCover_Surplus() {
	s.SetupTest()
	app := s.GetQuicksilverApp(s.chainA)
	ctx := s.chainA.GetContext()
...
func (s *AppTestSuite) TestV0101003UpgradeHandler_NoRecords() {
	s.SetupTest()
	app := s.GetQuicksilverApp(s.chainA)
	ctx := s.chainA.GetContext()
...
func (s *AppTestSuite) TestV0101003UpgradeHandler_ZoneNotFound() {
	s.SetupTest()
	app := s.GetQuicksilverApp(s.chainA)
	ctx := s.chainA.GetContext()
...
func (s *AppTestSuite) TestV0101003UpgradeHandler_MintToCover_SkipsMalformedWDR() {
	s.SetupTest()
	app := s.GetQuicksilverApp(s.chainA)
	ctx := s.chainA.GetContext()

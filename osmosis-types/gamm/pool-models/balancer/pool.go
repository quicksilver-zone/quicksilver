...
func (p *Pool) calcSingleAssetJoin(tokenIn sdk.Coin, swapFee sdk.Dec, tokenInPoolAsset PoolAsset, totalShares math.Int) (numShares math.Int, err error) {
...
func (p *Pool) JoinPool(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdk.Dec) (numShares math.Int, err error) {
...
// It updates the liquidity if the pool is joined successfully. If not, returns error.
func (p *Pool) JoinPoolNoSwap(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdk.Dec) (numShares math.Int, err error) {
...
func (p *Pool) CalcJoinPoolShares(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdk.Dec) (numShares math.Int, tokensJoined sdk.Coins, err error) {
...
func (p *Pool) CalcJoinPoolNoSwapShares(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdk.Dec) (numShares math.Int, tokensJoined sdk.Coins, err error) {
...
func (p *Pool) calcJoinSingleAssetTokensIn(tokensIn sdk.Coins, totalShares math.Int, poolAssetsByDenom map[string]PoolAsset, swapFee sdk.Dec) (math.Int, sdk.Coins, error) {
...
func (p *Pool) ExitPool(ctx sdk.Context, exitingShares math.Int, exitFee sdk.Dec) (exitingCoins sdk.Coins, err error) {
...
func (p *Pool) CalcTokenInShareAmountOut(
	...
	if !tokenInAmount.IsPositive() {
		return math.Int{}, sdkioerrors.Wrapf(gamm.ErrNotPositiveRequireAmount, nonPostiveTokenAmountErrFormat, tokenInAmount.Int64())
	}
...
func (p *Pool) ExitSwapExactAmountOut(
	...
	if !sharesIn.IsPositive() {
		return math.Int{}, sdkioerrors.Wrapf(gamm.ErrNotPositiveRequireAmount, nonPostiveSharesAmountErrFormat, sharesIn.Int64())
	}

	if sharesIn.GT(shareInMaxAmount) {
		return math.Int{}, sdkioerrors.Wrapf(gamm.ErrLimitMaxAmount, sharesLargerThanMaxErrFormat, sharesIn.Int64(), shareInMaxAmount.Uint64())
	}

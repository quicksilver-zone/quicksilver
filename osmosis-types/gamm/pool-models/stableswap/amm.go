...
func (p *Pool) calcSingleAssetJoinShares(tokenIn sdk.Coin, swapFee sdk.Dec) (math.Int, error) {
...
func (p *Pool) joinPoolSharesInternal(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdk.Dec) (numShares math.Int, newLiquidity sdk.Coins, err error) {
	if len(tokensIn) == 1 {

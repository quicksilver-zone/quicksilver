...
type PoolI interface {
	...
	GetSwapFee(ctx sdk.Context) sdkmath.LegacyDec
	...
	GetExitFee(ctx sdk.Context) sdkmath.LegacyDec
	...
	SwapOutAmtGivenIn(ctx sdk.Context, tokenIn sdk.Coins, tokenOutDenom string, swapFee sdkmath.LegacyDec) (tokenOut sdk.Coin, err error)
	...
	CalcOutAmtGivenIn(ctx sdk.Context, tokenIn sdk.Coins, tokenOutDenom string, swapFee sdkmath.LegacyDec) (tokenOut sdk.Coin, err error)

	// SwapInAmtGivenOut swaps exactly enough tokensIn against the pool, to get the provided tokenOut amount out of the pool.
	// Balance transfers are done in the keeper, but this method updates the internal pool state.
	SwapInAmtGivenOut(ctx sdk.Context, tokenOut sdk.Coins, tokenInDenom string, swapFee sdkmath.LegacyDec) (tokenIn sdk.Coin, err error)
	// CalcInAmtGivenOut returns how many coins SwapInAmtGivenOut would return on these arguments.
	// This does not mutate the pool, or state.
	CalcInAmtGivenOut(ctx sdk.Context, tokenOut sdk.Coins, tokenInDenom string, swapFee sdkmath.LegacyDec) (tokenIn sdk.Coin, err error)
	...
	SpotPrice(ctx sdk.Context, baseAssetDenom string, quoteAssetDenom string) (sdkmath.LegacyDec, error)
	...
	JoinPool(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdkmath.LegacyDec) (numShares sdkmath.Int, err error)
	...
	JoinPoolNoSwap(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdkmath.LegacyDec) (numShares sdkmath.Int, err error)

	// CalcJoinPoolShares returns how many LP shares JoinPool would return on these arguments.
	// This does not mutate the pool, or state.
	CalcJoinPoolShares(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdkmath.LegacyDec) (numShares sdkmath.Int, newLiquidity sdk.Coins, err error)

	// CalcJoinPoolNoSwapShares returns how many LP shares JoinPoolNoSwap would return on these arguments.
	// This does not mutate the pool, or state.
	CalcJoinPoolNoSwapShares(ctx sdk.Context, tokensIn sdk.Coins, swapFee sdkmath.LegacyDec) (numShares sdkmath.Int, newLiquidity sdk.Coins, err error)
	...
	ExitPool(ctx sdk.Context, numShares sdkmath.Int, exitFee sdkmath.LegacyDec) (exitedCoins sdk.Coins, err error)
	// CalcExitPoolCoinsFromShares returns how many coins ExitPool would return on these arguments.
	// This does not mutate the pool, or state.
	CalcExitPoolCoinsFromShares(ctx sdk.Context, numShares sdkmath.Int, exitFee sdkmath.LegacyDec) (exitedCoins sdk.Coins, err error)
...
type PoolAmountOutExtension interface {
	...
	IncreaseLiquidity(sharesOut sdkmath.Int, coinsIn sdk.Coins)
}

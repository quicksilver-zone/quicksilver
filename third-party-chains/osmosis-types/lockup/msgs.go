...
func (m MsgLockTokens) ValidateBasic() error {
	_, err := addressutils.AccAddressFromBech32(m.Owner, "")
	if err != nil {
...
func (m MsgLockTokens) GetSigners() []sdk.AccAddress {
	owner, _ := addressutils.AccAddressFromBech32(m.Owner, "")
...
func (m MsgSetRewardReceiverAddress) ValidateBasic() error {
	...
	_, err = addressutils.AccAddressFromBech32(m.RewardReceiver, "")
	if err != nil {
